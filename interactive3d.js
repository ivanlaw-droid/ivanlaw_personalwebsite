...
document.addEventListener("DOMContentLoaded", function () {
  // 1. 找到容器 + 檢查 Plotly 是否已載入
  var container = document.getElementById("skill-3d-chart");
  if (!container || typeof Plotly === "undefined") {
    console.error("3D chart container or Plotly not ready.");
    return;
  }
  ...
  const layout = {
    ...
    scene: {
      bgcolor: "rgba(224,242,254,0.9)", // 淺藍背景，避免變成純白看不到
